  ...
  for(var i = 0; i < enemyNames.length; i++) {
    ...
    // call fight function with enemy-robot
      ...
      if (playerHealth > 0 && i < enemyNames.length -1) {
        //ask if play whats to shop b4 next round
        var storeConfirm = window.confirm("the fight is over, vist the store b4 next round?");
        //if yes, take them to the store() func
        if (storeConfirm) {
...
var shop = function() {
  ...
  var shopOptionPrompt = window.prompt(
    "Woudl you like to refill you helth, upgrade your attack, or leave the store? Please enter one: 'REFILL', 'UPGRADE', or 'LEAVE' to make a choice."
  );
